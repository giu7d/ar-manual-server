...
export class InitialMigration1608730807347 implements MigrationInterface {
	...
	public async up(queryRunner: QueryRunner): Promise<void> {
		await queryRunner.query(
			`CREATE TABLE "instruction_source" ("id" uuid NOT NULL, "type" character varying NOT NULL, "src" character varying NOT NULL, "instructionId" uuid, CONSTRAINT "PK_e9ff25cd4d133ff86530dbb690d" PRIMARY KEY ("id"))`
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`CREATE TABLE "testbench" ("id" uuid NOT NULL, "componentSerialNumber" character varying NOT NULL, "testBenchSerialNumber" character varying NOT NULL, "thumbnailSrc" character varying NOT NULL DEFAULT 'placeholder-value', "qrCodeSrc" character varying NOT NULL DEFAULT 'placeholder-value', "isActive" boolean NOT NULL DEFAULT true, "caoId" uuid, CONSTRAINT "REL_cdd09a254cfbbdab841bf7a2c4" UNIQUE ("caoId"), CONSTRAINT "PK_e3db507594e1553fca798c42252" PRIMARY KEY ("id"))`
		);
		await queryRunner.query(
			`CREATE TABLE "warning" ("id" uuid NOT NULL, "description" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL, "instructionId" uuid, CONSTRAINT "PK_54ddc381cc95ffd6909e427b093" PRIMARY KEY ("id"))`
		);
		await queryRunner.query(
			`CREATE TABLE "instruction" ("id" uuid NOT NULL, "title" character varying NOT NULL, "description" character varying NOT NULL, "step" integer NOT NULL, "nextInstructionId" character varying, "testBenchId" uuid, CONSTRAINT "PK_dd8def68dee37e3f878d0f8673a" PRIMARY KEY ("id"))`
		);
		await queryRunner.query(
			`CREATE TABLE "analysis_step" ("id" uuid NOT NULL, "status" character varying NOT NULL, "failure" json, "startedAt" TIMESTAMP NOT NULL, "finishedAt" TIMESTAMP NOT NULL, "analysisId" uuid, "instructionId" uuid, CONSTRAINT "PK_71b3633f0d0dc4582b290101075" PRIMARY KEY ("id"))`
		);
		await queryRunner.query(
			`CREATE TABLE "analysis" ("id" uuid NOT NULL, "status" character varying NOT NULL, "startedAt" TIMESTAMP NOT NULL, "finishedAt" TIMESTAMP NOT NULL, "accountId" uuid, "testBenchId" uuid, CONSTRAINT "PK_300795d51c57ef52911ed65851f" PRIMARY KEY ("id"))`
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`ALTER TABLE "analysis_step" ADD CONSTRAINT "FK_9f6a09214ad88eb26d7d9b1c244" FOREIGN KEY ("instructionId") REFERENCES "instruction"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`
		);
		await queryRunner.query(
	...
	public async down(queryRunner: QueryRunner): Promise<void> {
		...
		await queryRunner.query(
			`ALTER TABLE "analysis_step" DROP CONSTRAINT "FK_9f6a09214ad88eb26d7d9b1c244"`
		);
		await queryRunner.query(
